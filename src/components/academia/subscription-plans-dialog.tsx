...
export function SubscriptionPlansDialog({ buttonTitle, user }: { buttonTitle?: string; user: User | null }) {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        ) : selectedPlan === initialState.actualRole ? (
          <Button disabled className="w-full mt-4">
            {initialState.button}
          </Button>
        ) : (
          <a 
            href={selectedPlan === "standard" ? generatePaymentLink(user.id, "STUDENT") : selectedPlan === "premium" ? generatePaymentLink(user.id, "STUDENT_P") : "#free-eliminar"}
